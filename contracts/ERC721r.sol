...
contract ERC721r is Context, ERC165, IERC721, IERC721Metadata {
    ...
    //..............................................
    struct usersTokesIDS{
        uint[] ids;
    }

    mapping(address => usersTokesIDS) _owner_;

    function getOwnerIDS(address _user) public view returns(usersTokesIDS memory){
        return _owner_[_user];
    }
    ...
    uint256 immutable _maxSupply;//10
    ...
    function _mintRandom(address to, uint _numToMint) internal  virtual {
        ...
        uint updatedNumAvailableTokens = _numAvailableTokens; //10
